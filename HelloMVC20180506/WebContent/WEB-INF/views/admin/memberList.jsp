...
#search-userId, #search-userName, div#search-Gender{}
	...
	<div id="search-container">
		...
		<div id="search-userId">
			<form action="<%= memberFiderUrl %> ">
				...
				<input type="search" name="searchKeyword" id="" size="25" placeholder="검색할 아이디를 입력하세요." required />
		...
		<div id="search-userName">
			<form action="<%= memberFiderUrl %>">
				...
				<input type="search" name="searchKeyword" id="" size="25" placeholder="검색할 회원명을 입력하세요." required />
				<button type ="submit">검색</button>
			</form>
		</div>
		<div id="search-gender">
			<form action="<%= memberFiderUrl %>">
				...
				<input type="radio" name="searchKeyword" id="" value="M" checked/> 남
				<input type="radio" name="searchKeyword" id="" value="F" /> 여
